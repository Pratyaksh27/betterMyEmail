export class FeedbackManager {
    ...
    static shouldShowFeedbackPopup() {
...
FeedbackManager.totalUses = '0';
FeedbackManager.lastFeedbackTime = 'null';
FeedbackManager.lastFeedbackGiven = 'false';
FeedbackManager.usesSinceLastFeedback = '0';
